...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Domain.ApprovingData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Lodging", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.LodgingAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.LodgingType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.PaymentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.ReservationItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.ReservationWindow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Token", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Domain.ApprovingData", b =>
                {
                    b.HasOne("Core.Entities.Domain.User", "User")
                        .WithOne("ApprovingData")
                        .HasForeignKey("Core.Entities.Domain.ApprovingData", "UserId")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Lodging", b =>
                {
                    b.HasOne("Core.Entities.Domain.LodgingType", "LodgingType")
                        .WithMany("Lodgings")
            ...
            modelBuilder.Entity("Core.Entities.Domain.LodgingAddress", b =>
                {
                    b.HasOne("Core.Entities.Domain.Country", "Country")
                    ...
                    b.HasOne("Core.Entities.Domain.Lodging", "Lodging")
                        .WithMany("LodgingAddresses")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Reservation", b =>
                {
                    b.HasOne("Core.Entities.Domain.PaymentType", "PaymentType")
            ...
            modelBuilder.Entity("Core.Entities.Domain.ReservationItem", b =>
                {
                    b.HasOne("Core.Entities.Domain.Reservation", "Reservation")
                    ...
                    b.HasOne("Core.Entities.Domain.ReservationWindow", "ReservationWindow")
                        .WithMany("ReservationItems")
                    ...
                    b.HasOne("Core.Entities.Domain.Room", "Room")
                        .WithMany("ReservationItems")
            ...
            modelBuilder.Entity("Core.Entities.Domain.Room", b =>
                {
                    b.HasOne("Core.Entities.Domain.Currency", "Currency")
                        .WithMany("Rooms")
            ...
            modelBuilder.Entity("Core.Entities.Domain.User", b =>
                {
                    b.HasOne("Core.Entities.Domain.Role", "Role")
                        .WithMany("Users")
